...
public class TicTacToe {
	...
	public static void main(String []args) {
		...
		String gameMode = "Select your preferred game mode?";
		Object [] optNew = {"Two Players","Vs Computer"};
		int opt = JOptionPane.showOptionDialog(Frame , gameMode,"Open a new text document", 
		...
		ImageIcon Ximg = new ImageIcon("X.png");
		Image image = Ximg.getImage();
		Image imag = image.getScaledInstance(5, 50, image.SCALE_DEFAULT);
		Icon scaledIcon = new ImageIcon(imag);
